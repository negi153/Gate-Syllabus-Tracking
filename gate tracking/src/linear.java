 ...
 * @author negi
 */
public class linear extends javax.swing.JPanel {

    
    JCheckBox cb[];
    makeChanges m = new makeChanges("linear");

    public linear() {
        initComponents();

        cb = new JCheckBox[]{cb1, cb1, cb2, cb3, cb4, cb5, cb6, cb7, cb8, cb9, cb10};
    ...
    private void initComponents() {
        ...
        cb3.setText("Multiplication of Determinants");
        ...
        cb8.setText("System of linear non-homogeneous equations");
        ...
        cb7.setText("System of linear homogenous equations");
        ...
        cb9.setText("Eigen values and vectors");
